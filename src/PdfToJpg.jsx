...
const handleSaveAllToFolder = async () => {
  ...
  return (
    <div className="min-h-screen bg-indigo-300 flex justify-center py-12 px-4">
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-sm border border-slate-200">
        ...
        <div className="px-8 py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border rounded-lg p-6 bg-slate-200">
  ...
  >
    {dirHandle ? "Change Folder" : "Select Output Folder"}
  </button>
</div>
          ...
          <div className="border rounded-lg p-6 bg-slate-200 flex flex-col justify-center">
  <p className="text-sm font-medium text-slate-700 mb-3">
    Upload PDFs
  </p>
  ...
  >
    <div className="w-full px-4 py-2 text-center rounded-md text-sm font-medium bg-slate-900 text-white hover:bg-slate-800 transition">
      Upload PDF Files
    </div>
  </label>
  ...
  <div className="px-8 py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    {images.map((img, i) => (
      <div
        ...
        className="border rounded-lg overflow-hidden bg-white hover:shadow transition"
      >
        <div className="h-[420px] bg-slate-50 flex items-center justify-center p-2">
          <img
            src={img.data}
            alt={img.name}
